...
TEST_CSV_PATH="./tcga_res/test.csv"
...
echo "========Fold1========"
LOG="./tcga_res/fold1/logs_fold1"
SAVE_MODEL_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold1/resnet34.pth"
TRAIN_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold1/train.csv"
VAL_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold1/val.csv"
python run.py \
    --k $K \
    --logdir $LOG \
    --num_epochs $NUM_EPOCHS \
...
echo "========Fold2========"
LOG="./tcga_res/fold2/logs_fold2"
SAVE_MODEL_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold2/resnet34.pth"
TRAIN_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold2/train.csv"
VAL_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold2/val.csv"
python run.py \
    --k $K \
    --logdir $LOG \
    --num_epochs $NUM_EPOCHS \
...
echo "========Fold3========"
LOG="./tcga_res/fold3/logs_fold3"
SAVE_MODEL_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold3/resnet34.pth"
TRAIN_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold3/train.csv"
VAL_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold3/val.csv"
python run.py \
    --k $K \
    --logdir $LOG \
    --num_epochs $NUM_EPOCHS \
...
echo "========Fold4========"
LOG="./tcga_res/fold4/logs_fold4"
SAVE_MODEL_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold4/resnet34.pth"
TRAIN_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold4/train.csv"
VAL_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold4/val.csv"
python run.py \
    --k $K \
    --logdir $LOG \
    --num_epochs $NUM_EPOCHS \
...
echo "========Fold5========"
LOG="./tcga_res/fold5/logs_fold5"
SAVE_MODEL_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold5/resnet34.pth"
TRAIN_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold5/train.csv"
VAL_CSV_PATH="/home/songjiali/code/Lung_Cancer/Maxpool/tcga_res/fold5/val.csv"
python run.py \
    --k $K \
    --logdir $LOG \
    --num_epochs $NUM_EPOCHS \
